...
Options := "x10p y30p w80p vCentre cbbffffff r4 s20 Underline Italic"
...
r := UpdateLayeredWindow(hwnd1, hdc, (A_ScreenWidth-Width)//2, (A_ScreenHeight-Height)//2, Width, Height)
; msgbox "r: " r
